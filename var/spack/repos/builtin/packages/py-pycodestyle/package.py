...
class PyPycodestyle(PythonPackage):
    ...
    version(
        "2.3.0",
        sha256="ac2a849987316521a56814b5618668d36cd5f3b04843803832a15b93b8383a50",
    )
    version(
        "2.2.0",
    ...
    version(
        "2.1.0",
        sha256="2190466d2b421da0d915b506eb690a6784feaef3ba33043665bf86581b02ccd9",
    )
    version(
        "2.0.0",
        sha256="7e65a888def0abc467fa2cf614b3f84a74a8991045a2adcf11e1c225d8798796",
    )
    version(
        "1.7.0",
    ...
    version(
        "1.6", sha256="5e7bb5156af311079345b5e81f8154c3e1420d723150a6cba5a70245eb0d515a"
    )
    version(
        "1.5.7",
