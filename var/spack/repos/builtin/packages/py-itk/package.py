...
class PyItk(Package):
    ...
    depends_on(
        "python@3.6.0:3.6.999", when="@5.1.1-cp36,5.1.2-cp36", type=("build", "run")
    )
    depends_on(
        "python@3.7.0:3.7.999", when="@5.1.1-cp37,5.1.2-cp37", type=("build", "run")
    )
    depends_on(
        "python@3.8.0:3.8.999", when="@5.1.1-cp38,5.1.2-cp38", type=("build", "run")
    )
