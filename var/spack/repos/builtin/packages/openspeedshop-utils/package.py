...
class OpenspeedshopUtils(CMakePackage):
    ...
    variant("cti", default=False, description="Build MRNet with the CTI startup option")
    variant(
        "crayfe",
        default=False,
    ...
    depends_on(
        "cbtf-krell@develop+cti", when="@develop+cti", type=("build", "link", "run")
    )
    depends_on(
        "cbtf-krell@1.9.3:9999+cti",
        when="@2.4.0:9999+cti",
        type=("build", "link", "run"),
    )

    depends_on(
        "cbtf-krell@develop+mpich", when="@develop+mpich", type=("build", "link", "run")
    )
    depends_on(
        "cbtf-krell@1.9.3:9999+mpich",
        when="@2.4.0:9999+mpich",
        type=("build", "link", "run"),
    )
    ...
    depends_on(
        "cbtf-krell@develop+mvapich",
        when="@develop+mvapich",
        type=("build", "link", "run"),
    )
    depends_on(
        "cbtf-krell@1.9.3:9999+mvapich",
        when="@2.4.0:9999+mvapich",
        type=("build", "link", "run"),
    )
    ...
    depends_on(
        "mrnet@5.0.1-3:+cti", when="@2.4.0:9999+cti", type=("build", "link", "run")
    )
    depends_on(
