...
class Openmpi(AutotoolsPackage):
    ...
    conflicts("+cxx", when="@5:", msg="C++ MPI bindings are removed in 5.0.X release")
    conflicts(
        "+cxx_exceptions", when="@5:", msg="C++ exceptions are removed in 5.0.X release"
    )
