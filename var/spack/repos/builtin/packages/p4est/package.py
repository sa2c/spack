...
class P4est(AutotoolsPackage):
    ...
    patch(
        "https://github.com/cburstedde/libsc/commit/b506aab224b988fec210cc212469f2c4f58b2d04.patch",
        sha256="e9418b1a9347a409be241cd185519b31950e42a7f55b6fb80ce53097657098ee",
        working_dir="sc",
        when="@2.0",
    )
    patch(
        "https://github.com/cburstedde/libsc/commit/b45a51a7ef97883a3d4dcbd05cb2c77890a76f75.patch",
