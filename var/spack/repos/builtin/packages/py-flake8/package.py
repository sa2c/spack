...
class PyFlake8(PythonPackage):
    ...
    version(
        "3.8.2",
        sha256="ae9b00ddaa2bb7fa69796ac73ba7607fcf06d79a8b777fa12ba5abef1e770491",
    )
    version(
        "3.7.8",
        sha256="201720797dc9691dd349819994e4a0bc281b70ee2ff77b0c928bb1d3c5aa9810",
    )
    version(
        "3.7.7",
        sha256="b3f76b02351008dc772276e74b09dd3d4b5c567ff8c6ab573352cb8fd7007444",
    )
    version(
        "3.5.0",
        sha256="60ffe2fdacce4ebe7cadc30f310cf1edfd8ff654ef79525d90cf0756e69de44e",
    )
    version(
        "3.0.4",
        sha256="87a2b642900a569fc2f27ab3b79573e0d02d2fee7445c6abab84eb33dcb60365",
    )
    version(
        "2.5.4",
        sha256="ce03cc1acbe1726775ca57b40fab1d177550debb2f2f6b7a3c860541f3971cf5",
    )
    ...
    # Flake8 3.8.X
    depends_on(
        "py-pycodestyle@2.6.0:2.6.999", when="@3.8.0:3.8.999", type=("build", "run")
    )
    depends_on(
        "py-pyflakes@2.2.0:2.2.999", when="@3.8.0:3.8.999", type=("build", "run")
    )
    ...
    depends_on(
        "py-pyflakes@2.1.0:2.1.999", when="@3.7.0:3.7.999", type=("build", "run")
    )
    depends_on(
        "py-pycodestyle@2.5.0:2.5.999", when="@3.7.0:3.7.999", type=("build", "run")
    )
    ...
    # Flake8 3.0.X
    depends_on(
        "py-pyflakes@0.8.1:1.1,1.2.3:1.2.999",
        when="@3.0.0:3.0.999",
        type=("build", "run"),
    )
    depends_on(
        "py-pycodestyle@2.0.0:2.0.999", when="@3.0.0:3.0.999", type=("build", "run")
    )
    ...
    depends_on(
        "py-pycodestyle@1.5.7:1.5.999,1.6.3:",
        when="@2.5.0:2.5.999",
        type=("build", "run"),
    )
    ...
    depends_on(
        "py-importlib-metadata", when="@3.8.0: ^python@:3.7", type=("build", "run")
    )
