...
class Adios2(CMakePackage):
    ...
    variant("shared", default=True, description="Also build shared libraries")
    variant(
        "pic",
        default=True,
    ...
    variant("blosc", default=True, description="Enable Blosc compression")
    ...
    def libs(self):
        ...
        if spec.satisfies("@2.6:"):
            ...
            if self.spec.satisfies("@2.7: +shared+hdf5") and self.spec[
                "hdf5"
            ].satisfies("@1.12:"):
