...
class Dbus(Package):
    ...
    version(
        "1.9.0",
        sha256="38ebc695b5cbbd239e0f149aa5d5395f0051a0fec1b74f21ff2921b22a31c171",
    )
    version(
        "1.8.8",
        sha256="dfab263649a979d0fff64a30cac374891a8e9940350e41f3bbd7679af32bd1fd",
    )
    version(
        "1.8.6",
        sha256="eded83ca007b719f32761e60fd8b9ffd0f5796a4caf455b01b5a5ef740ebd23f",
    )
    version(
        "1.8.4",
        sha256="3ef63dc8d0111042071ee7f7bafa0650c6ce2d7be957ef0b7ec269495a651ff8",
    )
    version(
        "1.8.2",
