...
class Python(AutotoolsPackage):
    ...
    def filter_compilers(self):
        ...
        filenames = [self.get_sysconfigdata_name(), self.get_makefile_filename()]
    ...
    def setup_dependent_package(self, module, dependent_spec):
        ...
        module.python_include_dir = join_path(
            dependent_spec.prefix, self.python_include_dir
        )
        module.site_packages_dir = join_path(
