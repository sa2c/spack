...
class Petsc(Package, CudaPackage, ROCmPackage):
    ...
    depends_on(
        "hypre@:2.13.99+mpi~internal-superlu~int64",
        when="@:3.8.99+hypre+mpi~complex~int64",
    )
    depends_on(
        "hypre@:2.13.99+mpi~internal-superlu+int64",
        when="@:3.8.99+hypre+mpi~complex+int64",
    ...
    depends_on(
        ...
        when="@3.9:3.13.99+hypre+mpi~complex~int64",
    )
    depends_on(
        "hypre@2.14:2.18.2+mpi~internal-superlu+int64",
        when="@3.9:3.13.99+hypre+mpi~complex+int64",
    ...
    depends_on(
        "hypre@2.14:+mpi~internal-superlu~int64", when="@3.14:+hypre+mpi~complex~int64"
    )
    depends_on(
        "hypre@2.14:+mpi~internal-superlu+int64", when="@3.14:+hypre+mpi~complex+int64"
    )
    depends_on(
        "hypre@xsdk-0.2.0+mpi~internal-superlu+int64",
        when="@xsdk-0.2.0+hypre+mpi~complex+int64",
    )
    depends_on(
        "hypre@xsdk-0.2.0+mpi~internal-superlu~int64",
        when="@xsdk-0.2.0+hypre+mpi~complex~int64",
    ...
    depends_on("superlu-dist@:4.3+int64", when="@3.4.4:3.6.4+superlu-dist+mpi+int64")
    depends_on(
        "superlu-dist@5.0.0:5.1.3~int64", when="@3.7:3.7.99+superlu-dist+mpi~int64"
    )
    depends_on(
        "superlu-dist@5.0.0:5.1.3+int64", when="@3.7:3.7.99+superlu-dist+mpi+int64"
    )
    depends_on(
        "superlu-dist@5.2:5.2.99~int64", when="@3.8:3.9.99+superlu-dist+mpi~int64"
    )
    depends_on(
        "superlu-dist@5.2:5.2.99+int64", when="@3.8:3.9.99+superlu-dist+mpi+int64"
    )
    depends_on(
        "superlu-dist@5.4:5.4.99~int64", when="@3.10:3.10.2+superlu-dist+mpi~int64"
    )
    depends_on(
        "superlu-dist@5.4:5.4.99+int64", when="@3.10:3.10.2+superlu-dist+mpi+int64"
    )
    depends_on(
        "superlu-dist@6.1:6.1.99~int64", when="@3.10.3:3.12.99+superlu-dist+mpi~int64"
    )
    depends_on(
        "superlu-dist@6.1:6.1.99+int64", when="@3.10.3:3.12.99+superlu-dist+mpi+int64"
    )
    ...
    depends_on("superlu-dist@6.1:+int64", when="@3.13.0:+superlu-dist+mpi+int64")
    depends_on(
        "superlu-dist@xsdk-0.2.0~int64", when="@xsdk-0.2.0+superlu-dist+mpi~int64"
    )
    depends_on(
        "superlu-dist@xsdk-0.2.0+int64", when="@xsdk-0.2.0+superlu-dist+mpi+int64"
    )
