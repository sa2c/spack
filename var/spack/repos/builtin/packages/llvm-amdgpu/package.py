...
class LlvmAmdgpu(CMakePackage):
    ...
    variant(
        "rocm-device-libs",
        default=True,
        description="Build ROCm device libs as external LLVM project instead of a standalone spack package.",  # noqa
    )
    ...
    def cmake_args(self):
        ...
        args = [self.define("LLVM_ENABLE_PROJECTS", ";".join(llvm_projects))]
