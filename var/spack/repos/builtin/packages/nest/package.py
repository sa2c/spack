...
class Nest(CMakePackage):
    ...
    version(
        "2.8.0",
        sha256="d47325b27a5599b6ea58a3c4ef06656e7c5a4941c4e94dec6a5c2fa956209915",
    )
    version(
        "2.6.0",
        sha256="5fe4924bc57d0c7dd820aa371de935eedf7e813832c0eee2c976b33c9a8db4cf",
    )
    version(
        "2.4.2",
        sha256="8f86e58c1a12b733ffabd8b0400326e5a3494a458149ea8ebe9f19674d05b91b",
    )
    ...
    conflicts(
        "~gsl", when="@:2.10.99", msg="Option only introduced for non-ancient versions."
    )
    conflicts(
        "~shared",
        when="@:2.10.99",
