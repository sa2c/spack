...
class Geant4(CMakePackage):
    ...
    for std in _cxxstd_values:
        ...
        depends_on("clhep@2.3.3.0: cxxstd=" + std, when="@10.3.3:10.6.99 cxxstd=" + std)
        ...
        depends_on(
            "vecgeom@1.1.8 cxxstd=" + std, when="@10.7.0: +vecgeom cxxstd=" + std
        )
        depends_on(
            "vecgeom@1.1.5 cxxstd=" + std, when="@10.6.0:10.6.99 +vecgeom cxxstd=" + std
        )
        depends_on(
            "vecgeom@1.1.0 cxxstd=" + std, when="@10.5.0:10.5.99 +vecgeom cxxstd=" + std
        )
        depends_on(
            "vecgeom@0.5.2 cxxstd=" + std, when="@10.4.0:10.4.99 +vecgeom cxxstd=" + std
        )
        depends_on(
            "vecgeom@0.3rc cxxstd=" + std, when="@10.3.0:10.3.99 +vecgeom cxxstd=" + std
        )
    ...
    def cmake_args(self):
        ...
        dataver = "{0}-{1}".format(
            spec["geant4-data"].name, spec["geant4-data"].version.dotted
        )
