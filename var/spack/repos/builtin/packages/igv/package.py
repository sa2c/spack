...
class Igv(Package):
    ...
    url = (
        "https://data.broadinstitute.org/igv/projects/downloads/2.8/IGV_Linux_2.8.0.zip"
    )
    ...
    version(
        "2.8.0",
        sha256="897f683645b02c4da55424110b885071c2b9dd51bc180174e2a9b10788bf3257",
    )
    ...
    def install(self, spec, prefix):
        ...
        mkdirp(prefix.bin)
        filter_file("^prefix=.*$", "prefix=" + prefix, "igv.sh", "igv_hidpi.sh")
