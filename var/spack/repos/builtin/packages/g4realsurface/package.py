...
class G4realsurface(Package):
    ...
    version(
        "2.2", sha256="9954dee0012f5331267f783690e912e72db5bf52ea9babecd12ea22282176820"
    )
    version(
        "2.1.1",
    ...
    version(
        "2.1", sha256="2a287adbda1c0292571edeae2082a65b7f7bd6cf2bf088432d1d6f889426dcf3"
    )
    version(
        "1.0", sha256="3e2d2506600d2780ed903f1f2681962e208039329347c58ba1916740679020b1"
    )

    def install(self, spec, prefix):
        mkdirp(join_path(prefix.share, "data"))
        install_path = join_path(
            prefix.share, "data", "RealSurface{0}".format(self.version)
        )
