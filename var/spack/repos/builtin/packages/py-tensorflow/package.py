...
class PyTensorflow(Package, CudaPackage):
    ...
    depends_on(
        "py-keras-applications@1.0.5:", type=("build", "run"), when="@1.11.0:1.11.999"
    )
    depends_on(
        "py-keras-preprocessing@1.1.2:1.1.999", type=("build", "run"), when="@2.4:"
    )
    depends_on(
        "py-keras-preprocessing@1.1.1:1.999", type=("build", "run"), when="@2.3:2.3.999"
    )
    ...
    depends_on(
        "py-keras-preprocessing@1.0.3:", type=("build", "run"), when="@1.11:1.11.999"
    )
    ...
    depends_on(
        "py-numpy@1.10.1:", type=("build", "run"), when="@0.7.1:0.7.999 platform=darwin"
    )
    ...
    depends_on("protobuf")
    depends_on(
        "flatbuffers+python@1.12.0:1.12.999", type=("build", "run"), when="@2.4.0:"
    )
    # tensorboard
    ...
    depends_on(
        "py-typing-extensions@3.7.4:3.7.999", type=("build", "run"), when="@2.4.0:"
    )
