...
class Hdf5(CMakePackage):
    ...
    conflicts(
        "api=v114", when="@1.6:1.12.99", msg="v114 is not compatible with this release"
    )
    conflicts(
        "api=v112", when="@1.6:1.10.99", msg="v112 is not compatible with this release"
    )
    conflicts(
        "api=v110", when="@1.6:1.8.99", msg="v110 is not compatible with this release"
    )
    conflicts(
        "api=v18", when="@1.6:1.6.99", msg="v18 is not compatible with this release"
    )
