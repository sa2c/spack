...
class Timemory(CMakePackage):
    ...
    variant(
        ...
        values=("auto", "kepler", "tesla", "maxwell", "pascal", "volta", "turing"),
        multi=False,
    )
    variant(
        "cpu_target",
    ...
    variant(
        ...
        default=False,
        description=(
            "Enable OpenMP tools support via drop-in "
    ...
    conflicts(
        "+python", when="~shared", msg="+python requires building shared libraries"
    )
    ...
    conflicts("+ompt_standalone", when="~ompt", msg="+ompt_standalone requires +ompt")
    conflicts("+ompt_llvm", when="~ompt", msg="+ompt_llvm requires +ompt")
    ...
    conflicts(
        "+ompt_standalone+ompt_llvm",
        msg=(
            "+ompt_standalone and +ompt_llvm are not compatible. Use "
