...
def test_url_patch(mock_patch_stage, filename, sha256, archive_sha256):
    ...
    patch = spack.patch.UrlPatch(pkg, url, sha256=sha256, archive_sha256=archive_sha256)
...
def test_patch_order(mock_packages, config):
    ...
    mid2_sha256 = "abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234"
...
def test_invalid_level(level):
    ...
    with pytest.raises(
        ValueError, match="Patch level needs to be a non-negative integer."
    ):
