...
class Likwid(Package):
    ...
    patch(
        "https://github.com/RRZE-HPC/likwid/commit/e0332ace8fe8ca7dcd4b4477a25e37944f173a5c.patch",
        when="@5.0.1",
        sha256="c3b8f939a46b425665577ce764d4fba080a23cab5999c53db71655fd54d7e0b1",
    )
    patch(
        "https://github.com/RRZE-HPC/likwid/commit/d2d0ef333b5e0997d7c80fc6ac1a473b5e47d084.patch",
        when="@4.3.4",
    ...
    patch(
        "https://github.com/RRZE-HPC/likwid/releases/download/v5.1.0/likwid-mpirun-5.1.0.patch",
        when="@5.1.0",
