...
class PyScipy(PythonPackage):
    ...
    depends_on(
        "python@2.7:2.8,3.4:", when="@0.18:1.2.999", type=("build", "link", "run")
    )
    ...
    depends_on(
        "py-numpy@1.5.1:+blas+lapack", when="@:0.15.999", type=("build", "link", "run")
    )
    depends_on(
        "py-numpy@1.6.2:+blas+lapack",
        when="@0.16:0.17.999",
        type=("build", "link", "run"),
    )
    depends_on(
    ...
    depends_on(
        "py-numpy@1.16.5:1.22.999+blas+lapack",
        when="@1.6.2:",
        type=("build", "link", "run"),
    )
