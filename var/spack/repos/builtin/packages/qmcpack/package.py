...
class Qmcpack(CMakePackage, CudaPackage):
    ...
    patch_url = (
        "https://patch-diff.githubusercontent.com/raw/QMCPACK/qmcpack/pull/621.patch"
    )
    ...
    patch_url = (
        "https://patch-diff.githubusercontent.com/raw/QMCPACK/qmcpack/pull/623.patch"
    )
    ...
    patch_url = (
        "https://patch-diff.githubusercontent.com/raw/QMCPACK/qmcpack/pull/643.patch"
    )
