...
class Openblas(MakefilePackage):
    ...
    patch(
        "https://github.com/xianyi/OpenBLAS/commit/4d183e5567346f80f2ef97eb98f8601c47f8cb56.patch",
    ...
    patch(
        "https://github.com/xianyi/OpenBLAS/commit/f42e84d46c52f4ee1e05af8f365cd85de8a77b95.patch",
    ...
    def _microarch_target_args(self):
        ...
        openblas_arch = set(
            ["alpha", "arm", "ia64", "mips", "mips64", "power", "sparc", "zarch"]
        )
        openblas_arch_map = {
            "amd64": "x86_64",
            "powerpc64": "power",
