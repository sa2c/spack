...
class Boost(Package):
    ...
    version(
        "1.38.0",
        sha256="3ee3a45af4d2fabf343b9e05cfbe033c35d63719b45a6554d5849e4a34216066",
    )
    version(
        "1.37.0",
        sha256="d52ef49f70b1b9addc4e0d1a3a2a1966227f0d173c3301bac3e6d399eeac5472",
    )
    version(
        "1.36.0",
    ...
    version(
        "1.34.0",
        sha256="455cb8fa41b759272768257c2e7bdc5c47ec113245dfa533f275e787a855efd2",
    )
    ...
    default_noinstall_libs = set(
        ["container", "context", "coroutine", "fiber", "mpi", "python"]
    )
