...
class Hpctoolkit(AutotoolsPackage):
    ...
    conflicts("+cuda", when="@:2019.99.99", msg="cuda requires 2020.03.01 or later")

    conflicts("+rocm", when="@:2020.99.99", msg="rocm requires 2021.03.01 or later")
