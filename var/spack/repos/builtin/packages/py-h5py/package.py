...
class PyH5py(PythonPackage):
    ...
    depends_on(
        "py-numpy@1.12:", type=("build", "run"), when="@3.0.0:^python@3.6.0:3.6.99"
    )
    depends_on(
        "py-numpy@1.14.5:", type=("build", "run"), when="@3.0.0:^python@3.7.0:3.7.99"
    )
    depends_on(
        "py-numpy@1.17.5:", type=("build", "run"), when="@3.0.0:^python@3.8.0:3.8.99"
    )
    ...
    depends_on(
        "py-mpi4py@3.0.0:",
        when="@3.0.0:+mpi^python@3.0.0:3.7.99",
        type=("build", "run"),
    )
    depends_on(
        "py-mpi4py@3.0.3:", when="@3.0.0:+mpi^python@3.8.0:", type=("build", "run")
    )
