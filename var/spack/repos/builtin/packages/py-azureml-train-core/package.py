...
class PyAzuremlTrainCore(Package):
    ...
    depends_on(
        "py-azureml-train-restclients-hyperdrive@1.23.0:1.23.999",
        when="@1.23.0",
        type=("build", "run"),
    )
    ...
    depends_on(
        "py-azureml-train-restclients-hyperdrive@1.11.0:1.11.999",
        when="@1.11.0",
        type=("build", "run"),
    )
    ...
    depends_on(
        "py-azureml-train-restclients-hyperdrive@1.8.0:1.8.999",
        when="@1.8.0",
        type=("build", "run"),
    )
