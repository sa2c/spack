...
class Gmake(AutotoolsPackage, GNUMirrorPackage):
    ...
    version(
        "4.3", sha256="e05fdde47c5f7ca45cb697e973894ff4f5d79e13b750ed57d7b66d8defc78e19"
    )
    version(
        "4.2.1",
    ...
    version(
        "4.0", sha256="fc42139fb0d4b4291929788ebaf77e2a4de7eaca95e31f3634ef7d4932051f69"
    )

    variant(
        "guile", default=False, description="Support GNU Guile for embedded scripting"
    )
