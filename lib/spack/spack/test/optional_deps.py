...
@pytest.fixture(
    params=[
        ...
        (
            ...
            {"optional-dep-test%intel@64.1": {"c": None, "d": None}},
        ),
        (
        ...
        (
            ...
            {"optional-dep-test+a@1.1": {"a": None, "b": None}},
        ),
        (
            "optional-dep-test+a%intel",
            {"optional-dep-test+a%intel": {"a": None, "c": None}},
        ),
        (
            "optional-dep-test@1.1%intel",
            {"optional-dep-test@1.1%intel": {"b": None, "c": None}},
        ),
        (
        ...
        (
            "optional-dep-test+f",
            {"optional-dep-test+f": {"f": None, "g": None, "mpi": None}},
        ),
    ]
)
